...
function animateSidebar(isOpening){
    if(isAnimating){if(currentFrame) cancelAnimationFrame(currentFrame);}
    isAnimating = true;
...
let startY;
sidebar.addEventListener('touchstart',function(e){startY=e.touches[0].clientY;},{passive:true});
...
window.addEventListener('load',function(){
    const images=['gambar/ua.png','gambar/ua1.png','gambar/c0.png','gambar/dd.png','gambar/ee.png'];
    let loadedCount=0;
    images.forEach(src=>{
        const img=new Image();
        img.onload=()=>{
